...
| General Report 3.0 | все таблицы | только свои |
...
Пока подключений нет и все живут на общем ключе из env — Reports видят все.
То есть разграничение Reports упирается только в подключения, и больше ни во что.
