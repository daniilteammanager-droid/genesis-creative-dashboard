...
| Креативы (новая) | всё | только то, что **загрузил сам** |
...
Уже загруженные файлы владельца не имеют, и backfill не нужен: они живут в
легаси-библиотеке, которую и так видят все.
